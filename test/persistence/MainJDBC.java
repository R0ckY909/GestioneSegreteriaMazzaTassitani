...
//	- Aggiungere l'entita' INDIRIZZO(codice, nome) per lo studente (uno studente ha un solo indirizzo)
//	- Aggiungere l'entita' CORSO(codice, nome), molti a molti con Studente.
	...
	public static void main(String args[]) {
		...
		Indirizzo indirizzo1 = new Indirizzo(new Long(1), "Informatica");
		Indirizzo indirizzo2 = new Indirizzo(new Long(2), "Matematica");
		...
		// l'id del gruppo è gestito tramite la classe IDBroker
