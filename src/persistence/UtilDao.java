	...
	public void createDatabase() {
		...
		try {
			String delete = "create SEQUENCE sequenza_id;"
					+ "create table gruppo (\"codice\" bigint primary key, nome varchar(255));"
					...
					+ "create table studente(matricola CHARACTER(8) primary key, nome VARCHAR(255), cognome VARCHAR(255), data_nascita DATE, gruppo_id bigint REFERENCES gruppo(\"id\"), indirizzo_codice bigint REFERENCES indirizzo(\"codice\"), corso_codice bigint REFERENCES corso(\"codice\"));";		
			PreparedStatement statement = connection.prepareStatement(delete);
			statement.executeUpdate();
